...
def compress_context(
    ...
    *,
    ...
    # A pre-bound agent may have loaded breaker/cooldown state before another
    # path compacted this session.  Re-read durable state after acquiring the
    # session lock so a stale snapshot cannot start a second compression.
    if not force:
